...
/** OG
 * 
 * Returns the firebase uid of the receiver of the chat message.
 * 
 * @param {*} chatID The firebase chatID that is unique to the two users
 * @param {*} senderID The firebae uid of the sender of the chat message (logged in user)
 * @returns The firebase uid of the receiver of the chat message
 */
